      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 pb-24 sm:pb-8">
        ...
        <div className="mb-6">
          {loading ? (
            ...
            <div>
              ...
              <p className="text-sm text-neutral-500 mt-1">Every account has been addressed.</p>
            </div>
          ) : (
            <div>
              <h1 className="text-2xl font-bold text-neutral-900 tracking-tight">Get started</h1>
              <p className="text-sm text-neutral-500 mt-1">Add your first customer account to begin.</p>
            </div>
          )}
        </div>
        ...
        {loading ? (
          ...
          >
            <div className="bg-white border border-neutral-200 rounded-xl px-6 py-8 text-center">
              <div className="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center mx-auto mb-4">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="1.75"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
              </div>
              <p className="text-base font-semibold text-neutral-900 mb-1">No customer accounts yet</p>
              <p className="text-sm text-neutral-500 leading-relaxed mb-6 max-w-sm mx-auto">
                Add your first WhatsApp group conversation. Nectic will read it, find what needs attention, and draft a response.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link
                  href="/concept/workspace?tab=connections"
                  className="flex items-center gap-2 bg-[#25D366] text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-[#1ebe5d] transition-colors"
                >
                ...
                <Link
                  href="/concept"
                  className="flex items-center gap-2 bg-white border border-neutral-200 text-neutral-700 text-sm font-semibold px-5 py-2.5 rounded-xl hover:border-neutral-400 transition-colors"
                >
            ...
            <p className="text-center text-[11px] text-neutral-400">
              Prefer to connect WhatsApp groups directly? Go to{" "}
              <Link href="/concept/workspace?tab=connections" className="underline hover:text-neutral-600">Settings → Connections</Link>
            </p>
          </motion.div>
        ) : queue.length === 0 ? (
          <motion.div
          ...
          >
            ...
            <p className="text-xs text-neutral-400">Every account has been addressed. Well done.</p>
          </motion.div>
        ) : (
