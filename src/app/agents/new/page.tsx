...
const ToolMarketplace = lazy(() => import("@/components/agents/ToolMarketplace"))
const VisualWorkflowBuilder = lazy(() => import("@/components/agents/VisualWorkflowBuilder"))
const AgentConfiguration = lazy(() => import("@/components/agents/AgentConfiguration"))
const OAuthConnections = lazy(() => import("@/components/agents/OAuthConnections"))
