  ...
  return (
    <div className="flex-1 space-y-6 p-6 md:p-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Compare and select the best vendor for implementing {opportunity.name}</p>
      </div>
      ...
      >
        ...
        <TabsContent value="comparison">
          <Card>
            ...
            <CardContent>
              <VendorComparisonMatrix vendors={vendors} features={features} />
            </CardContent>
          </Card>
        </TabsContent>
